...
public class AugmentedImageActivity extends AppCompatActivity {
  ...
  /**private void setImage(AugmentedImageNode augmentedImageNode, AugmentedImage augmentedImage) {
    ...
    Node node = new Node();
    augmentedImageNode.setAnchor(augmentedImage.createAnchor(augmentedImage.getCenterPose()));
    node.setParent(augmentedImageNode);
